    ...
    public static class ComposerUX
    {
        ...
        private static string AddChildView()
        {
            using (new SampleMethodScope())
            {
                ...
                view.Properties = new ObservableCollection<ViewProperty>
                {
                    new ViewProperty { Name = "Name", Value = _composerViewName },
                    new ViewProperty { Name = "DisplayName", Value = _composerViewDisplayName },
                    version
                };
        ...
        private static string AddChildViewFromTemplate()
        {
            using (new SampleMethodScope())
            {
                ...
                view.Properties = new ObservableCollection<ViewProperty>
                {
                    new ViewProperty { Name = "Template", Value = _templateName },
                    version
                };
                result = Proxy.DoCommand(_authoringContainer.DoAction(view));
                result.Messages.Should().NotContainErrors();
        ...
        private static void MakeTemplate(string composerViewItemId)
        {
            using (new SampleMethodScope())
            {
                ...
                view.Properties = new ObservableCollection<ViewProperty>
                {
                    new ViewProperty { Name = "Name", Value = _templateName },
        ...
        private static void CreateTemplate()
        {
            using (new SampleMethodScope())
            {
                ...
                view.Properties = new ObservableCollection<ViewProperty>
                {
                    ...
                    new ViewProperty { Name = "DisplayName", Value = $"My Console Template {partial}" },
                    new ViewProperty { Name = "ViewName", Value = $"MyConsoleView{partial}" },
                    new ViewProperty { Name = "ViewDisplayName", Value = $"My Console View {partial}" }
                };
                result = Proxy.DoCommand(_authoringContainer.DoAction(view));
                result.Messages.Should().NotContainErrors();
                ...
                var templatesView = Proxy.GetValue(
                    _authoringContainer.GetEntityView(string.Empty, "ComposerTemplates", string.Empty, string.Empty));
                templatesView.Should().NotBeNull();
                templatesView.ChildViews.OfType<EntityView>().Any(v => v.ItemId.Equals(templateName.ToEntityId<Plugin.Composer.ComposerTemplate>())).Should().BeTrue();
            }
        }
    }
}
