namespace Sitecore.Commerce.Extensions
{
    ...
    public static class EngineExtensions
    {
        ...
        public static readonly Lazy<Engine.Container> AuthoringContainer =
            new Lazy<Engine.Container>(() => AuthoringContext.Value.ShopsContainer());
        ...
        public static void WaitUntilCompletion(
            this Core.Commands.CommerceCommand command,
        ...
        public static void AddCatalog(string catalogName, string displayName)
        {
            ...
            var view = Proxy.GetValue(
                EngineExtensions.AuthoringContainer.Value.GetEntityView(
                    string.Empty,
                    "Details",
                    "AddCatalog",
                    string.Empty));
        ...
        public static void DeleteCatalogIfExists(string catalogName)
        {
            var getCatalogResult =
                Proxy.GetValue(EngineExtensions.AuthoringContainer.Value.Catalogs.ByKey(catalogName));
        ...
        public static void AddInventorySet(string inventorySetName)
        {
            using (new SampleMethodScope())
            {
                ...
                view.Properties = new ObservableCollection<ViewProperty>
                {
                    ...
                    new ViewProperty
                        { Name = "Description", Value = $"{inventorySetName} Console UX Inventory Set Description" }
                };
            ...
            int backorderLimit = 0)
        {
            ...
            view.Properties = new ObservableCollection<ViewProperty>
            {
                ...
                new ViewProperty
                    { Name = "Quantity", Value = quantity.ToString(), OriginalType = typeof(int).FullName },
                new ViewProperty
                    { Name = "Preorderable", Value = preorderable.ToString(), OriginalType = typeof(bool).FullName },
                new ViewProperty
                {
                ...
                new ViewProperty
                    { Name = "PreorderLimit", Value = preorderLimit.ToString(), OriginalType = typeof(int).FullName },
                new ViewProperty
                    { Name = "Backorderable", Value = backorderable.ToString(), OriginalType = typeof(bool).FullName },
                new ViewProperty
                {
        ...
        public static void DeleteSellableItem(string productId, string parentId, string parentName, string catalogName)
        {
            using (new SampleMethodScope())
            {
                ...
                getResult = Proxy.GetValue(
                    EngineExtensions.AuthoringContainer.Value.SellableItems.ByKey(
        ...
        public static void DeleteCategoryIfExists(string categoryId)
        {
            var getCategoryResult =
                Proxy.GetValue(EngineExtensions.AuthoringContainer.Value.Categories.ByKey(categoryId));
        ...
        public static void DeleteCategory(string categoryId)
        {
            using (new SampleMethodScope())
            {
                ...
                var selectDeleteOptionResult = Proxy.DoCommand(
                    EngineExtensions.AuthoringContainer.Value.DoAction(selectDeleteOptionView));
                ...
                view.Properties = new ObservableCollection<ViewProperty>
                {
                    new ViewProperty
                    {
                        Name = "Version", Value = (getCategoryResult.Version + 1).ToString(),
            ...
            int attempts = 5)
        {
            using (new SampleMethodScope())
            {
                for (var i = 0; i < attempts; i++)
                {
                    ...
                    var policies = new Collection<CommerceOps.Sitecore.Commerce.Core.Policy>
                    {
        ...
        public static void NotContainErrors(
            this GenericCollectionAssertions<Core.CommandMessage> assertion,
            params string[] allowedErrorTerms)
        {
        ...
        public static InventorySet AssertInventorySetExists(string inventorySetId)
        {
            var getResult = Proxy.GetValue(
                EngineExtensions.AuthoringContainer.Value.InventorySets.ByKey(inventorySetId));
